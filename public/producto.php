...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="layout-test">
        ...
        <div class="box contenedor1">
            <img src="<?= htmlspecialchars($productoEncontrado['Imagen'])?>" alt="">
        </div>

        <div class="box contenedor2">
            <p>
                <?= htmlspecialchars($productoEncontrado['Descripcion'])?>
            </p>

            <ul>
                <?php foreach ($productoEncontrado['Descripcion1'] as $clave => $valor): ?>
                <li>
                    <strong>
    ...
    endforeach; ?>
        ...
        <!-- Layout caja -->
        <div class="d-flex contenedor3">

            <div class="caja d-flex flex-column">

                <h3 class="text-center">
                    <?= htmlspecialchars($productoEncontrado['Nombre'])?>
                </h3>

                <p>
                    <?= htmlspecialchars($productoEncontrado['ContenidoC'])?>
                </p>

                <!-- Precio -->
                <p class="text-success fw-bold fs-4">
                    $
                    <?= number_format($productoEncontrado['Precio'], 0, ',', '.')?> COP
                </p>

                <!-- Botón -->
                <div class="mt-auto">
                    <a href="../src/cart.php?action=add&id=<?= $productoEncontrado['id']?>"
